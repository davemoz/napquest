...
- Always put styles in a module.scss file that corresponds to the component or page being styled
- Use the component or page name as the module file name, eg. "MyComponent.module.scss"
